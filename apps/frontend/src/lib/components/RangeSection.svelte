<script lang="ts">
  ...
  let {
    ...
    section: Section;
    // Caller pre-buckets tasks into the section they belong to (mutually
    // exclusive across Daily and all other range sections), so this component
    // just sorts and renders.
    tasks: Task[];
